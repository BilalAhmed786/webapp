...
?>
       ...
       <div class=" pure-menu custom-display">
        ...
        <li class="pure-menu-item">
            <a href="http://localhost/webapp/admin/forms/adminprofile.php" class="pure-menu-link">
                Profile
            </a>
            ...
            <li class="pure-menu-item
                ...
                <ul class="pure-menu-children">
                    ...
                    <li class="pure-menu-item">
                        <a href="http://localhost/webapp/admin/forms/productimggallery.php"
                           class="pure-menu-link">
                            product image gallery
                        </a>
                    </li>
                    <li class="pure-menu-item">
                        <a href="http://localhost/webapp/admin/forms/addgalleryimages.php"
                           class="pure-menu-link">
                            Add gallery images
                        </a>
                    </li>
            ...
            <li style=margin-top:10px !important class="pure-menu-item">
                <a href="http://localhost/webapp/admin/forms/customerorddet.php"
                   class="pure-menu-link">
                   <?php
                   if($countorders!=0){
        ...
        <li style=margin-top:10px !important class="pure-menu-item">
            <a href="http://localhost/webapp/admin/forms/retypepassword.php" class="pure-menu-link">
                Reset password
            </a>
        </li>
