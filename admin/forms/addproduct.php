...
$productvalid='';
    if (isset($_POST['submit'])) {
        ...
        $q = "select * from add_product where productname='$productname'"; 
...
for ($i = 0; $i < count($_FILES['images']['name']); $i++) {
        ...
        if ($results=='') {
            ...
            $q = "insert into add_product(productname, productdescripton, productshortdescription, productcategory, productimage, Inventory, saleprice, discountedprice) 
        values('$productname', '$productshortdesc', '$productdesc', '$productcat', '$destination', '$inventory', '$saleprice', '$discountprice' )";
            mysqli_query($conn, $q);
        } else {
            $productvalid = "<p style=color:red;>This product already added</P>";
        }
    ...
    <div class="rows">
        ...
        <div class="adminmain">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="button" id="loadFileXml" class="addbutton" value="ProductImage"
