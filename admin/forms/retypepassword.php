...
<body>
    ...
    <div class="rows">
        ...
        <div style=margin:auto;padding:auto;width:50% class="resetpass">
            <h4>Reset password</h4>
            <form id="resetpassword" method="post" action="retypepassword.php">
                <div class=form-group>

                    <input id="oldpass" class="form-control" type="password" name="oldpassword" placeholder="Oldpassword">
                </div>
                <div class=form-group>
                ...
                <div class=form-group>
                    ...
                    <input class="form-control" type="password" name="retypenewpass"
